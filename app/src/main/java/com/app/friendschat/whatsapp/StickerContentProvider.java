...
public class StickerContentProvider extends ContentProvider {
    ...
    private List<com.app.friendschat.whatsapp.StickerPack> stickerPackList;
    ...
    public boolean onCreate() {
        ...
        for (com.app.friendschat.whatsapp.StickerPack stickerPack : getStickerPackList()) {
            MATCHER.addURI(authority, STICKERS_ASSET + "/" + stickerPack.identifier + "/" + stickerPack.trayImageFile, STICKER_PACK_TRAY_ICON_CODE);
            for (com.app.friendschat.whatsapp.Sticker sticker : stickerPack.getStickers()) {
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, String selection,
        ...
        if(com.app.friendschat.whatsapp.StickerBook.getAllStickerPacks().isEmpty()){
            com.app.friendschat.whatsapp.StickerBook.init(getContext());
        }
    ...
    public AssetFileDescriptor openAssetFile(@NonNull Uri uri, @NonNull String mode) {
        ...
        com.app.friendschat.whatsapp.StickerPack csp = com.app.friendschat.whatsapp.StickerBook.getStickerPackByIdWithContext(pathSegments.get(pathSegments.size() - 2), getContext());
        if(csp!=null){
    ...
    public List<com.app.friendschat.whatsapp.StickerPack> getStickerPackList() {
    ...
    private Cursor getCursorForSingleStickerPack(@NonNull Uri uri) {
        ...
        return getStickerPackInfo(uri, new ArrayList<com.app.friendschat.whatsapp.StickerPack>());
    }

    @NonNull
    private Cursor getStickerPackInfo(@NonNull Uri uri, @NonNull List<com.app.friendschat.whatsapp.StickerPack> stickerPackList) {
        ...
        for (com.app.friendschat.whatsapp.StickerPack stickerPack : stickerPackList) {
