...
public abstract class Sticker {
    ...
    private boolean isHide; //cho phép sticker có hiển thị hay không

    private boolean dirty;// kiểm tra xem drawableSticker đã được vẽ chưa
    ...
    @NonNull
    public Sticker setPagerSelect(int pager) {
        pagerSelect = pager;
        return this;
    }
    ...
    @NonNull
    public Sticker setPosSelect(int pos) {
        posSelect = pos;
        return this;
    }
    ...
    @NonNull
    public Sticker setLock(boolean lock) {
        isLock = lock;
        return this;
    }
    ...
    @NonNull
    public Sticker setHide(boolean hide) {
        isHide = hide;
        return this;
    }
