...
import com.app.friendschat.utils.custom_view.brushes.BrushSettings;
...
import com.app.friendschat.utils.custom_view.brushes.androidpathbrushes.PathBrush;
import com.app.friendschat.utils.custom_view.brushes.stampbrushes.StampBrush;
...
public class BrushPreviewPerformer {
    ...
    private List<float[]> initializeCurve(Context context, int w, int h){
        ...
        float approximatedArcLength =
                com.app.friendschat.utils.custom_view.Utilities.dist(curvePoints[0][0],curvePoints[0][1], curvePoints[1][0],curvePoints[1][1]) +
                        com.app.friendschat.utils.custom_view.Utilities.dist(curvePoints[1][0],curvePoints[1][1],curvePoints[2][0],curvePoints[2][1]) +
                        com.app.friendschat.utils.custom_view.Utilities.dist(curvePoints[2][0],curvePoints[2][1],curvePoints[3][0],curvePoints[3][1]);
        ...
        for (; i < size; i++) {
            ...
            pointList.add(point);
            com.app.friendschat.utils.custom_view.Utilities.cubicBezier(
